...
<body class="body">
    <form class="login-form" action="register.php" method="post">
        <h1 class="login-form__title-text">Sign Up</h1>
        ...
        <input class="input login-form__input" type="password" name="confirm_password" placeholder="Password" style="background:#0a0e31;" required>
        <input class="button login-form__button" type="submit" value="Login">
        <p class="register_text">Already have an account? <a href="login.php">Login now</a>.</p>
    </form>
</body>
</html>